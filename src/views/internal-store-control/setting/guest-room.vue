    ...
    export default {
      ...
      methods: {
        ...
        rmchg_reason(){
          ...
          //获取信息列表
          that.$axios({
            url:that.api+"/v1/system/settings/get_code_base_list/?parent_code=dept_maint_reason",
            method: "get",
            headers: {
        ...
        gain_market(){
          ...
          //获取信息列表
          that.$axios({
            url: that.api+"/v1/system/settings/get_code_base_list/?page_size=100&parent_code=maint_clx_reason&ordering=-modify_datetime",
            method: "get",
            headers: {
              authorization: sessionStorage.getItem("authorization"),
            }
