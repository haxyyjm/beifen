            ...
            <el-submenu index="1">
              ...
              <el-menu-item-group :default-active="this.$route.path" router mode="horizontal">
                <el-menu-item index="1-1">
                  <router-link to="/MemberPlan">会员计划</router-link>
                </el-menu-item>
                <el-menu-item index="1-2">
                  <router-link to="/Integral">积分设置</router-link>
                </el-menu-item>
                <el-menu-item index="1-3">
                  <router-link to="/Stored">储值设置</router-link>
                </el-menu-item>
                <el-menu-item index="1-4">
                  <router-link to="/SaleRules">促销规则</router-link>
                </el-menu-item>
              </el-menu-item-group>
            </el-submenu>
            <el-submenu index="2">
              ...
              <el-menu-item-group :default-active="this.$route.path" router mode="horizontal">
                <el-menu-item index="2-1">
                  <router-link to="/MemberList">会员列表</router-link>
                </el-menu-item>
                <el-menu-item index="2-2">
                  <router-link to="/IntegralList">积分列表</router-link>
                </el-menu-item>
                <el-menu-item index="2-3">
                  <router-link to="/StoredList">储值列表</router-link>
                </el-menu-item>
              </el-menu-item-group>
            </el-submenu>
          </el-menu>
