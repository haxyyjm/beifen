  ...
  <div class="MemberPlan">
      ...
      <el-dialog title="编辑" :visible.sync="outerVisible">
            <div class="outdialog">
              ...
              <div v-if="cardLevelNewadd" class="cardTypeLevel self_inline_block" ><img style="cursor: not-allowed;" src="../member/img/icon-newAdd.png" alt=""></div>
              <div v-else class="cardTypeLevel self_inline_block" @click="classNewAddExtraShow()"><img src="../member/img/icon-newAdd.png" alt=""></div>
              <div class="classMes">
                <!-- 表格 -->
                <div class="table">  
                  <table style="width: 100%;">
    ...
    export default {
        ...
        methods:{
          ...
          getTabsData:function() {
             //设置请求路径
             let url  = this.UrLHeader+"customer/member/get_card_type_list/?code_type=MB",
                _this = this;                
            // 发送请求:将数据返回到一个回到函数中
