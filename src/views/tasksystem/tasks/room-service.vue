  ...
  <div class="room-service">
    <div class="title">
      <el-tabs v-model="activeName2" type="card" @tab-click="handleClick">
        <el-tab-pane label="未送餐" name="second">
          <div class="grabble">
            <div>
              <span>房间号 ：</span>
            ...
            <el-table
              ...
              <el-table-column
                ...
                <template slot-scope="scope" >
                  ...
                  <el-button size="mini" @click="dialog_entertain = true;reception(scope.row,scope.row.id,scope.$index, income_list) ">送餐</el-button>
                </template>
              </el-table-column>
          ...
          <el-dialog
            ...
            <ul class="dialog_style">
              <li>
                ...
                <span>编号 ：</span>
                <el-input v-model="param.master_single_num" placeholder="请输入内容"  style="width: 210px;"></el-input>
              </li>
              <li>
                <i style="color: red;font-size: 18px">*</i>
                <span>房间号 ：</span>
              ...
              <li>
                <i style="color: red;font-size: 18px">*</i>
                <span>餐饮订单id ：</span>
                <el-input v-model="meal_order_id" placeholder="请输入内容"   style="width: 210px;"  oninput ="value=value.replace(/[^\d]/g,'')"> </el-input>
              </li>
              <li>
                <i style="color: red;font-size: 18px">*</i>
                <span>送餐状态 ：</span>
        ...
        <el-tab-pane label="待送餐" name="third">
          <div class="grabble">
            <div>
              <span>房间号 ：</span>
    ...
    export default {
      ...
      methods: {
        ...
        enter_code(){
          let that = this;
          that.$axios({
            url: "http://47.98.113.173:9104/v1/room_service/meal/get_rs_meal_list/",
            method: "get",
            headers: {
              authorization: sessionStorage.getItem("authorization"),
            }
        ...
        cancel(id,index,list){
          ...
          that.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
            ...
            list.splice(index, 1);
            that.$axios({
              url:"http://47.98.113.173:9104/v1/room_service/meal/remove_rs_meal/"+id +'/',
              method: "post",
              headers: {
                authorization: sessionStorage.getItem("authorization"),
              }
        ...
        amend(srow,id,index,list){
          ...
          //
           that.param.master_single_num=srow.master_single_num, //编号
            ...
            that.meal_order_id=srow.meal_order_id//餐饮订单id

        },
        //点击未送物新增和修改后的保存
        ensure(){
          let that=this;
          if(that.param.master_single_num==="" ||that.room_no==="" ||that.status==="" ||that.meal_order_id==="" ){
            that.hintInfo("warning", "*为必填项")
          }else {
          let urldata = that.Edite ? ("http://47.98.113.173:9104/v1/room_service/meal/update_rs_meal/"+that.id+'/') :  ("http://47.98.113.173:9104/v1/room_service/meal/add_rs_meal/");
          ...
          that.$axios({
            ...
            data:{
              ...
              meal_order_id:that.meal_order_id,
            },
            headers: {
              authorization: sessionStorage.getItem("authorization"),
            }
        ...
        determine(){
          ...
          if(that.complete_user_name===""){
            that.hintInfo("warning", "请选择配送人")
          }else {
          that.$axios({
            url: "http://47.98.113.173:9104/v1/room_service/meal/update_rs_meal/"+that.id+'/',
            method: "post",
            data:{
              status:parseInt(that.status),//订单状态
