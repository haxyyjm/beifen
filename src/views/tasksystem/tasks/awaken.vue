      ...
      <el-tabs v-model="activeName2" type="card" @tab-click="handleClick">
            ...
            <el-table
              ...
              <el-table-column
                ...
                <template slot-scope="scope" >
                  ...
                  <el-button size="mini" @click="dialog_entertain = true;reception(scope.row,scope.row.id,scope.$index, income_list) ">叫醒</el-button>
                </template>
              </el-table-column>
          ...
          <el-dialog
            ...
            <ul class="dialog_style">
              ...
              <li>
                <i style="color: red;font-size: 18px">*</i>
                <span>房间电话号码 ：</span>
                <el-input v-model="param.room_phone_num" placeholder="请输入内容"  style="width: 217px;"     ></el-input>
              </li>
              <li>
                <i style="color: red;font-size: 18px">*</i>
                <span>叫醒来源 ：</span>
                <el-select v-model="wakeup_type"  placeholder="请选择" >
                  <el-option
          ...
          <el-dialog
            ...
            <ul class="dialog_style">
              <li >
                ...
                <el-select v-model="awaken_man"   placeholder="请选择" >
                  <el-option
        ...
        <el-tab-pane label="已完成" name="routing">
          <div class="grabble">
            <div>
              <span>房间号 ：</span>
              <el-select v-model="achieve_room"  clearable placeholder="请选择">
                <el-option
                  v-for="item in room_number"
                  :key="item.room_no"
                  :label="item.room_no"
        ...
        <el-tab-pane label="已删除" name="delete">
          <div class="grabble">
            <div>
              <span>房间号 ：</span>
              <el-select v-model=" delete_room"  clearable placeholder="请选择">
                <el-option
                  v-for="item in room_number"
                  :key="item.room_no"
                  :label="item.room_no"
    ...
    export default {
      ...
      methods: {
        ...
        enter_code(){
          let that = this;
          that.$axios({
            url: "http://47.98.113.173:9104/v1/room_service/wakeup/get_rs_wake_up_list/",
            method: "get",
            headers: {
              authorization: sessionStorage.getItem("authorization"),
            }
        ...
        cancel(id,index,list){
          ...
          that.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
            ...
            list.splice(index, 1);
            that.$axios({
              url:"http://47.98.113.173:9104/v1/room_service/wakeup/remove_rs_wake_up/"+id +'/',
              method: "post",
              headers: {
                authorization: sessionStorage.getItem("authorization"),
              }
        ...
        //点击未叫醒新增和修改后的保存
          ...
          if(that.param.master_single_num==="" ||that.room_no==="" ||that.status==="" || that.param.room_phone_num==="" ||that.wakeup_type==="" ||that.wakeup_time===""){
            ...
            if (!tel.test(that.param.room_phone_num)) {
              ...
              let urldata = that.Edite ? ("http://47.98.113.173:9104/v1/room_service/wakeup/update_rs_wake_up/" + that.id + '/') : ("http://47.98.113.173:9104/v1/room_service/wakeup/add_rs_wake_up/");
        ...
        determine(){
          ...
          if(that.awaken_man===""){
            ...
            that.$axios({
              url: "http://47.98.113.173:9104/v1/room_service/wakeup/update_rs_wake_up/" + that.id + "/",
              method: "post",
              data: {
       ...
       * */
        ...
        filtrate(){
          ...
          if(that.not_room==="" && that.reception_time==="" ){
            ...
            if(that.room_number===""){
              ...
              that.$axios({
                url: "http://47.98.113.173:9104/v1/room_service/wakeup/get_rs_wake_up_list/?room_no="+that.not_room+"&"+"plan_start_time="+that.reception_time,
                method: "get",
                headers: {
                  authorization: sessionStorage.getItem("authorization"),
                }
        ...
        reception_filtrate(){
          ...
          if(that.reception_room==="" && that.reception_data==="" &&that.reception_man===""){
            ...
            that.$axios({
              url: "http://47.98.113.173:9104/v1/room_service/wakeup/get_rs_wake_up_list/?room_no="+that.reception_room+"&"+"plan_start_time="+that.reception_data+"&"+"complete_user_name="+that.reception_man,
              method: "get",
              headers: {
                authorization: sessionStorage.getItem("authorization"),
              }
        ...
        achieve_filtrate(){
          ...
          if(that.achieve_room==="" && that.achieve_time==="" &&that.achieve_man===""){
            ...
            that.$axios({
              url: "http://47.98.113.173:9104/v1/room_service/wakeup/get_rs_wake_up_list/?room_no="+that.achieve_room+"&"+"plan_start_time="+that.achieve_time+"&"+"complete_user_name="+that.achieve_man,
              method: "get",
              headers: {
                authorization: sessionStorage.getItem("authorization"),
              }
