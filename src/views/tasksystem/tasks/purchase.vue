  ...
  <div class="purchase">
    <div class="title">
      <el-tabs v-model="activeName2" type="card" @tab-click="handleClick">
        <el-tab-pane label="未采购" name="second">
          <div class="grabble">
            <div>
              <span>房间号 ：</span>
          ...
          <el-dialog
            ...
            <span slot="footer" class="dialog-footer">
              ...
              <el-button type="primary" @click="dialog_entertain = false;determine()">确 定</el-button>
             </span>
          </el-dialog>
        </el-tab-pane>
        <el-tab-pane label="待采购" name="third">
          <div class="grabble">
            <div>
              <span>房间号 ：</span>
...
<script>
    export default {
      ...
      methods: {
        ...
        //封装错误信息
        error_message(msg){
          this.$message.error('错了哦，暂时没有数据加载');
        },
        /**
         * @flush 是用来刷新数据的
         * */
