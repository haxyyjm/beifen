<template>
  <div class="page-all">
    ...
    <el-card>
      <el-header>
        <li>
          <img src="@/assets/images/pincontrol-treasure/treasure/cash-coupon/Diamond.png" />变价券列表:
        </li>
      </el-header>
    ...
    <el-dialog
      ...
      width="60%">
      <ul>
        <li style="float: right;margin-bottom: 0.8vw"><span></span><input/><button>查询</button></li>
      </ul>
      <el-table
