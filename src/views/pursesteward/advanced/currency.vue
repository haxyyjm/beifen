  ...
  <div class="currency">
    ...
    <div class="shopping">
      <div  style="position: relative">
        <span style="vertical-align: top;display: inline-block;line-height: 35px;padding:10px;font-weight: bold">币种设置</span>
    ...
    export default {
      ...
      methods: {
        ...
        enter_code(){
          let that=this
          that.$axios({
            url:'http://47.98.113.173:9103/v1/system/settings/get_currency_list/',
            method: "get",
            headers: {
        ...
        screen(){
          let that=this
          that.$axios({
            url: that.api+"/v1/finance/money_type/info_list",
            method: "post",
            data:{
        ...
        cancel(id,index,list){
          ...
          that.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
            ...
            list.splice(index, 1);
            that.$axios({
              url:""+that.api+"/v1/finance/money_type/remove/"+id,
              method: "get",
              headers: {
                authorization: sessionStorage.getItem("authorization"),
              }
        ...
        //点击入账代码新增和修改后的保存
          ...
          let that=this;
          let urldata = that.Edite ? (""+that.api+"/v1/finance/money_type/update/"+that.id) :  (that.api+"/v1/finance/money_type/add");
