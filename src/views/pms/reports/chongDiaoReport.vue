<template>
  ...
  <div style="width: calc(100% - 60px); margin: auto">
      <div style="border: 1px dashed; margin-top: 20px; margin-bottom: 20px; height: 50px">
          <el-row>
            <h2 style="text-align: center; line-height: 50px">催账报表</h2>
      ...
      <el-row>
          ...
          <el-table-column prop="pay_sum" label="累计付款"></el-table-column>
          <el-table-column prop="charge_sum" label="累计消费"></el-table-column>
          <el-table-column prop="balance" label="余额"></el-table-column>
          <el-table-column prop="expect_unpaid" label="预计欠款"></el-table-column>
          <el-table-column prop="arr_date" label="抵达日期"></el-table-column>
          <el-table-column prop="leave_date" label="离开日期"></el-table-column>
