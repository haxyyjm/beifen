<template>
  ...
  <div style="width: calc(100% - 60px); margin: auto">
      <div style="border: 1px dashed; margin-top: 20px; margin-bottom: 20px; height: 50px">
          <el-row>
            <h2 style="text-align: center; line-height: 50px">结账区间明细表</h2>
      ...
      <el-row>
          ...
          <el-table-column prop="damage_sum" label="赔偿金"></el-table-column>
          <el-table-column prop="other_charge_sum" label="其他消费"></el-table-column>
          <el-table-column prop="charge_sum" label="消费总额"></el-table-column>
          <el-table-column prop="cash_sum" label="现金"></el-table-column>
          <el-table-column prop="bank_card_sum" label="银行卡"></el-table-column>
          <el-table-column prop="wx_sum" label="微信"></el-table-column>
          <el-table-column prop="other_pay_sum" label="其他支付方式合计"></el-table-column>
          <el-table-column prop="pay_amount" label="支付总额"></el-table-column>
          <el-table-column prop="biz_date" label="账务日期"></el-table-column>
          <el-table-column prop="close_time" fixed="right" label="操作时间"></el-table-column>
        </el-table>
      </el-row>
      <el-pagination
