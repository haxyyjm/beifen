<template>
  ...
  <div style="width: calc(100% - 60px); margin: auto">
      <div style="border: 1px dashed; margin-top: 20px; margin-bottom: 20px; height: 50px">
          <el-row>
            <h2 style="text-align: center; line-height: 50px">销售员业绩汇总报表</h2>
            <span style="float: left; margin-top: -25px; margin-left: 18px">上海皇冠晶品酒店虹桥店</span>
      ...
      <el-row>
          ...
          <el-table-column prop="code_income_type_id.name" label="入账类型" width="180"></el-table-column>
          <el-table-column prop="charge_amount" label="消费金额"></el-table-column>
          <el-table-column prop="create_user.real_name" label="操作人"></el-table-column>
