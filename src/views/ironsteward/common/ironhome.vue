  ...
  <el-row class="container">
    ...
    <el-col :span="24" class="topbar-wrap">
      ...
      <div class="topbar-title">
        <el-row v-show="$store.state.topNavState==='ironhome'"><!-- 注意：这里就是topNavState作用之处，根据当前路由所在根路由的type值判断显示不同顶部导航菜单 -->
          <el-col :span="24">
            <el-menu :default-active="defaultActiveIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect" :router="true">
              <el-menu-item index="/ironsteward">设备房态图</el-menu-item>
              <el-menu-item index="/equipmenttype">设备类型设置</el-menu-item>
              <el-menu-item index="/equipmentguest">客房设备方案</el-menu-item>
              <el-menu-item index="/guestcontrol">客控方案设置</el-menu-item>
              <el-menu-item index="/equipmentcommon">酒店公共方案设置</el-menu-item>
            </el-menu>
          </el-col>
        </el-row>
      </div>
