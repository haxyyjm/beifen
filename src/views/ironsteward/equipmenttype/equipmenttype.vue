        ...
        <el-card class="box-card">
          <el-table
            ...
            <el-table-column
              label="父级ID">
              <template slot-scope="scope">
                <span>{{ scope.row.hierarchy_id }}</span>
              </template>
            </el-table-column>
            <el-table-column
              label="设备名称">
            ...
            <el-table-column
              label="是否公共设置">
              <template slot-scope="scope">
                <span v-if="scope.row.is_set_common">是</span>
                <span v-if="!scope.row.is_set_common">否</span>
              </template>
            </el-table-column>
            <el-table-column
              label="英文描述">
              <template slot-scope="scope">
                <span>{{ scope.row.english_description }}</span>
              </template>
            </el-table-column>
            <el-table-column
              label="创建时间">
