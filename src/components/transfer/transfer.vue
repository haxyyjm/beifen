<template>
    <div class="transfer">
        ...
        <div class="center">
            <el-button class="el-icon-arrow-right" type="primary" circle :disabled="btn_toright" @click="toright"></el-button><br/>
            <el-row style="height: 20px"></el-row>
            <el-button class="el-icon-arrow-left " type="primary" circle :disabled="btn_toleft" @click="toleft"></el-button>
        </div>
        <div class="right" style="width: 400px">
            ...
            <div class="content-body">
                ...
                <check-block-right v-for="(item,index) in transferData_right" :key="item[showFlied]" :transferData="transferData_right" :parentText="item[showFlied]" :parentText2="item[showFlied2]" :childData="item[childFlid]" :showFlied="showFlied" :showFlied2="showFlied2" :childFlid="childFlid" @setAccount="setAccount2" @checkBoxChange="checkBoxChange2">
                </check-block-right>
            </div>
            <div class="foot">
...
<script>
import CheckBlock from '@/components/transfer/CheckBlock'
import CheckBlockRight from '@/components/transfer/CheckBlockRight'
...
export default {
    ...
    methods: {
        ...
        setAccount2(val){
            console.log('val',val)
            console.log(',,,',this.checkBlock2)
            console.log('触发事件!',this.transferData_right)
             for(var item of this.transferData_right){
                 console.log(item[this.showFlied],'单一行')
                 if(item[this.showFlied] === val){
                     item[this.showFlied] = val+ '|'
                 }
             }
            console.log(this.parentText,'parentText')
        },
        //处理选框数据
